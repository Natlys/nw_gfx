...
ifeq ($(config),work_win64)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -L../nc_lib -L/usr/lib64 -m64
...
ifeq ($(config),game_win64)
  ...
  LIBS += ../nc_lib/bin_cxx/nc_lib.lib
  LDDEPS += ../nc_lib/bin_cxx/nc_lib.lib
  ALL_LDFLAGS += $(LDFLAGS) -L../nc_lib -L/usr/lib64 -m64 -s
  LINKCMD = $(CC) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
$(OBJDIR)/nc_gfx.o: src_cxx/nc_gfx.cxx
	@echo $(notdir $<)
