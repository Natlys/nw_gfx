...
namespace NC
{
	...
	// operators //
	op_stream_t& gfx_buf_vtx_t::operator<<(op_stream_t& stm) const { gfx_buf_t::operator<<(stm); return stm; }
	ip_stream_t& gfx_buf_vtx_t::operator>>(ip_stream_t& stm) { gfx_buf_t::operator>>(stm); return stm; }
	// commands //
