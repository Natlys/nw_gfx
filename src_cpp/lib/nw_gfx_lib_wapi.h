...
namespace NW
{
	extern v1bit gfx_load_wapi();
	extern v1bit gfx_ext_load_wapi();
}
...
namespace NW
{
	...
	// other
	typedef ptr_t          (__stdcall* pfn_gfx_get_proc)       (cstr name);
	// extensions
	typedef cstr           (__stdcall* pfn_gfx_ext_get_str)    (v1nil);
